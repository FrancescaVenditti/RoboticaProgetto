...
def generate_launch_description():
    ...
    # Declare the launch argument for rviz_config
    ...
    # Set the RViz configuration file based on the launch argument
    rviz_base = os.path.join(get_package_share_directory('franka_moveit_config'), 'rviz')
    rviz_config_file = LaunchConfiguration('rviz_config')
    rviz_full_config = PathJoinSubstitution([rviz_base, rviz_config_file])
